...
JustGage = function(config) {
  ...
  obj.config = {
    ...
    valueFontColor: kvLookup('valueFontColor', config, dataset, "#e7e6e6"),
    ...
    levelColors: kvLookup('levelColors', config, dataset, ["#d5ff44", "#ffb431", "#ff6161"], 'array', ','),
  ...
  if (obj.config.relativeGaugeSize === true) {
    obj.canvas.setViewBox(0, 0, 250, 100, true);
  }
